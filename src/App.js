    ...
    <div className=" container-fluid" id="rootChild">
     ...
     <div   id="mainContent" className="">
                    ...
                    {myMedia.map((item,index)=><div className="videoContainer" key={index}>
                      <div className="position-relative  mx-auto  bg-info"><video className="  myVideos mx-auto rounded d-flex" controls autoPlay     loop > <source src={item}  type="video/mp4"></source>
